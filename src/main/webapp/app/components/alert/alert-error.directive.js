(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('akcjamisApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-akcjamisApp-error');
                var entityKey = httpResponse.headers('X-akcjamisApp-params');
                if (errorHeader) {
