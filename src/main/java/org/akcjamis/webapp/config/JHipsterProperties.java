...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "akcjamis@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "akcjamis API";

        private String description = "akcjamis API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "akcjamis";
